...
const bodymodal = document.getElementById('mod') as HTMLElement;
const code = document.getElementById('code') as HTMLElement;
const iscode = document.getElementById('iscode') as HTMLInputElement;
const modal2 = document.getElementById('modal2') as HTMLInputElement;
const btn = document.querySelector('.btn') as HTMLInputElement;
const tbodyy = document.querySelector('tbody') as HTMLElement;
    ...
    fetch(apiHistorique, {
        ...
        .then((data) => {
            ...
            data.forEach((element: any) => {
                ...
                transactions.forEach((transaction: any, index: any) => {
                    tbodyy.innerHTML += `
                <td>
